...
public class TrashController {
    ...
    @FXML
    private VBox vboxArchivedNotes;
    @FXML
    ...
    private VBox createArchivedNoteCard(Note note) {
        ...
        card.setStyle(
                "-fx-background-color: #1e293b; -fx-background-radius: 8; -fx-border-color: #334155; -fx-border-radius: 8;");
        ...
        // Deleted date
        String deletedDate = note.getUpdatedAt() != null ? "Deleted: " + DATE_FORMAT.format(note.getUpdatedAt())
                : "Deleted: Unknown";
        ...
        if (selectedNote != null && selectedNote.getId() == note.getId()) {
            card.setStyle(
                    "-fx-background-color: #334155; -fx-background-radius: 8; -fx-border-color: #3b82f6; -fx-border-width: 2; -fx-border-radius: 8;");
        }
    ...
    private void selectNote(Note note) {
        ...
        lblArchivedDate.setText(
                "Deleted: " + (note.getUpdatedAt() != null ? DATE_FORMAT.format(note.getUpdatedAt()) : "Unknown"));
    ...
    private void handleEmptyTrash() {
        ...
        confirmDialog.setContentText("Bạn có CHẮC CHẮN muốn xóa vĩnh viễn TẤT CẢ " + archivedNotes.size()
