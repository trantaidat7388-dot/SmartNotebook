...
public class SmartTextUtil {
     ...
     * 
     * @deprecated Sử dụng
     *             {@link com.dat.notebook.service.SummaryService#summarize(String)}
     *             thay thế.
     *             SummaryService có thuật toán TF-IDF hoàn chỉnh hơn.
     * 
     ...
     * 
     * @deprecated Sử dụng
     *             {@link com.dat.notebook.service.TitleSuggestionService#suggestTitle(String)}
     *             thay thế.
     *             TitleSuggestionService có nhiều chiến lược gợi ý tiêu đề tốt hơn.
     * 
     ...
     * 
     * @deprecated Sử dụng
     *             {@link com.dat.notebook.service.ai.KeywordExtractor#extractKeywords(String)}
     *             thay thế.
     *             KeywordExtractor có thuật toán TF-IDF hoàn chỉnh hơn.
     * 
     * @param content Nội dung
